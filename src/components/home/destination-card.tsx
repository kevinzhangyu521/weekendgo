...
export function DestinationCard({ item, locale, homeCity, badgeLabel, imagePriority = false }: Props) {
  ...
  return (
    <Link href={`/destinations/${item.id}`} className="block overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
